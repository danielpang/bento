...
export function FeatureDrawer({
  ...
  /** Set before the first await, so a second click cannot start another publish. */
  ...
  async function publishNow() {
    // setState has not re-rendered yet when a second click lands, so the ref
    // is what keeps one press from publishing twice.
