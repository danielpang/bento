  ...
  return [
    ...
    },
    {
      ...
      landings: [
        {
          id: "ld-1",
          taskId: "t-tests-happy",
          branchName: "swarm/checkout-tests",
          position: 0,
          status: "landed",
          attempt: 1,
          error: null,
          resolverRunId: null,
          startedAt: iso(now, -30 * MINUTE),
          endedAt: iso(now, -29 * MINUTE),
        },
        {
          id: "ld-2",
          taskId: "t-pay-refund",
          branchName: "swarm/checkout-refund",
          position: 1,
          status: "conflicted",
          attempt: 2,
          error: "CONFLICT (content): Merge conflict in src/payments/refund.ts",
          resolverRunId: "run-resolver-1",
          startedAt: iso(now, -4 * MINUTE),
          endedAt: null,
        },
      ],
      ledger: [
