...
ALTER TABLE "feature_messages" ADD CONSTRAINT "feature_messages_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "identity"."user"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
