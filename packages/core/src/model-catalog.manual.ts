 ...
 * described nowhere the generator looks. Those are the entries here.
 *
 ...
 *
 * If models.dev later grows a Cursor provider, the generator will pick
 * it up and these ids merge on top: already-listed ones stay put, Auto
 * and any Composer variant the snapshot missed still appear.
 *
 ...
 *
 * The Mac app draws no mark for this provider yet. It reads its marks as
 * PNGs rendered by scripts/render-provider-logos.mjs, which needs a mac
 * to run, and logoIdFor() in apps/mac/src/wire.ts answers zero for any
