// Generated by scripts/update-models.mjs from https://ai-gateway.vercel.sh/v1/models
// Snapshot taken 2026-09-12. Do not edit by hand: run `pnpm models:update`.
// Language models only. Image, video, and embedding ids stay out.
import type { CatalogProvider } from "./models.js";

export const GATEWAY_CATALOG: readonly CatalogProvider[] = [
  {
    "id": "vercel",
